...
Email Address: Luojingw@usc.edu
...
: When a location is added to the queue array. 
...
: my maze is a 10 by 12 maze that has three different paths from start to end.
Yes. it did behave as expected finding the shortest path.
